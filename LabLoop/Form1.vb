...
Public Class Form1
    Private Sub CalculateBtn_Click(sender As Object, e As EventArgs) Handles CalculateBtn.Click
        ...
        If Val(StartNumTextbox.Text) <= 0 Then
            ...
            StartValueResultLabel.Text = ""
            EndValueResultLabel.Text = ""
            ValueResultLabel.Text = ""
        End If
        ...
        If (Val(StartNumTextbox.Text > 0) And (Val(EndNumTextbox.Text)) < 1001 And (Val(EndNumTextbox.Text) > Val(StartNumTextbox.Text))) Then
            ' calculate
